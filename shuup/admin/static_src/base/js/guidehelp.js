...
// import * as guideTexts from './guide_help_texts';
// import { guideTexts } from './guide_help_texts/index.js';
...
function processGuideTexts() {
  ...
  heurestics in the future, like showing related/sibling/parent guide articles. */
...
$("#guide-button").on("click", (e) => {
  ...
  if(results.length != 0 && results !== undefined){
    ...
    window.Messages.enqueue({
        tags: "error",
        text: gettext("Error! Guide help text was not found for this URL.")
    });
  }
});
